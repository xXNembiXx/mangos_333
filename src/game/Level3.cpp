...
bool ChatHandler::HandleReloadAllSpellCommand(const char*)
{
	...
	HandleReloadSpellThreatMultiplicatorsCommand("a");
...
bool ChatHandler::HandleReloadSpellThreatMultiplicatorsCommand(const char*)
{
...
bool ChatHandler::HandleReloadVehicleDataCommand(const char* /*args*/)
{
...
bool ChatHandler::HandleReloadVehicleSeatDataCommand(const char* /*args*/)
{
